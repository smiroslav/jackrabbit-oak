...
public class AzureTarWriterTest extends TarWriterTest {
    ...
    protected SegmentArchiveManager getSegmentArchiveManager() throws Exception {
        ...
        AzureArchiveManager azureArchiveManager = new AzureArchiveManager(blobContainerClient, "oak", new IOMonitorAdapter(), monitor, writeAccessController);
    ...
    protected SegmentArchiveManager getFailingSegmentArchiveManager() throws Exception {
        ...
        writeAccessController.enableWriting();
        return new AzureArchiveManager(blobContainerClient, "oak", new IOMonitorAdapter(), monitor, writeAccessController) {
            @Override
            public SegmentArchiveWriter create(String archiveName) throws IOException {
                return new AzureSegmentArchiveWriter(blobContainerClient, archiveName, "oak", ioMonitor, monitor, writeAccessController) {
                    @Override
